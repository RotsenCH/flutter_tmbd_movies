import 'package:flutter_tmbd/constants/api_constants.dart';
...
class Endpoints {
  static String discoverMoviesUrl(int page) {
    return '$TMDB_API_BASE_URL'
        ...
        '$TMDB_API_KEY'
        '&language=es-ES&sort_by=popularity'
  ...
  static String nowPlayingMoviesUrl(int page) {
    return '$TMDB_API_BASE_URL'
        ...
        '$TMDB_API_KEY'
        '&language=es-ES&include_adult=false&page=$page';
  }

  static String getCreditsUrl(int id) {
    return '$TMDB_API_BASE_URL' + '/movie/$id/credits?api_key=$TMDB_API_KEY&language=es-ES';
  }
  ...
  static String movieDetailsUrl(int movieId) {
    return '$TMDB_API_BASE_URL/movie/$movieId?api_key=$TMDB_API_KEY&language=es-ES&append_to_response=credits,'
        'images';
  }

  static String genresUrl() {
    return '$TMDB_API_BASE_URL/genre/movie/list?api_key=$TMDB_API_KEY&language=es-ES';
  }
  ...
  static String movieSearchUrl(String query) {
    return "$TMDB_API_BASE_URL/search/movie?query=$query&api_key=$TMDB_API_KEY&language=es-ES";
  }

  static String personSearchUrl(String query) {
    return "$TMDB_API_BASE_URL/search/person?query=$query&api_key=$TMDB_API_KEY&language=es-ES";
  }

  static getPerson(int personId) {
    return "$TMDB_API_BASE_URL/person/$personId?api_key=$TMDB_API_KEY&language=es-ES&append_to_response=movie_credits";
  }
}
