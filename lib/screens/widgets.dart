...
import 'package:flutter_tmbd/modal_class/credits.dart';
...
import 'package:flutter_tmbd/screens/castncrew.dart';
import 'package:flutter_tmbd/screens/genremovies.dart';
        ...
        Row(
          ...
          children: <Widget>[
            Padding(
              ...
              child:
                  Text('Explorar', style: widget.themeData.textTheme.headlineSmall),
            ),
          ],
        ),
        SizedBox(
